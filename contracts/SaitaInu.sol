...
contract SaitaInu is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address public  deadAddress = address(0x553fA24217F937f480904809011Ac0Cc4eC9170F);
    ...
    constructor() ERC20("Saita Inu", "Saita Inu") {
        ...
        maxWallet = totalSupply * 9 / 1000; // 2.5% maxWallet
